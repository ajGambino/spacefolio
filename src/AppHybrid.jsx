...
function AppHybrid() {
	...
	const handleCloseProjectsOverlay = () => setIsProjectsOverlayOpen(false);
	const handleCloseCreditsOverlay = () => setIsCreditsOverlayOpen(false);
	const handleCloseAboutOverlay = () => setIsAboutOverlayOpen(false);
	const handleCloseContactOverlay = () => setIsContactOverlayOpen(false);
